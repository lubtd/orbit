...
func New(
	...
	app.OrbitKeeper = *orbitmodulekeeper.NewKeeper(
		appCodec,
		keys[orbitmoduletypes.StoreKey],
		keys[orbitmoduletypes.MemStoreKey],
		app.GetSubspace(orbitmoduletypes.ModuleName),
	)
