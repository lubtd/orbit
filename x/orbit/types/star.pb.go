...
func (*Star) Descriptor() ([]byte, []int) {
	return fileDescriptor_5013e053d79cd147, []int{0}
}
...
func init() {
	proto.RegisterType((*Star)(nil), "lubtd.orbit.orbit.Star")
}

func init() { proto.RegisterFile("orbit/star.proto", fileDescriptor_5013e053d79cd147) }

var fileDescriptor_5013e053d79cd147 = []byte{
	// 170 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xc8, 0x2f, 0x4a, 0xca,
	0x2c, 0xd1, 0x2f, 0x2e, 0x49, 0x2c, 0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xcc, 0x29,
	0x4d, 0x2a, 0x49, 0xd1, 0x03, 0x8b, 0x43, 0x48, 0x25, 0x17, 0x2e, 0x96, 0xe0, 0x92, 0xc4, 0x22,
	...
	0x5b, 0x48, 0x82, 0x8b, 0x3d, 0xb9, 0x28, 0x35, 0xb1, 0x24, 0xbf, 0x48, 0x82, 0x19, 0x2c, 0x0c,
	0xe3, 0x3a, 0xd9, 0x9d, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c,
	0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x4a, 0x7a,
	0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xd8, 0x76, 0x7d, 0x88, 0xab, 0x2a,
	0xa0, 0x74, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0xd8, 0x7d, 0xc6, 0x80, 0x00, 0x00, 0x00,
	0xff, 0xff, 0x5b, 0xf6, 0xf5, 0x7b, 0xb3, 0x00, 0x00, 0x00,
}
...
func (m *Star) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintStar(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintStar(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
		i = encodeVarintStar(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func skipStar(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupStar
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupStar = fmt.Errorf("proto: unexpected end of group")
)
