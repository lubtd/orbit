...
const baseQueryGetStarRequest = { id: 0 };
export const QueryGetStarRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetStarRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryGetStarResponse = {};
export const QueryGetStarResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetStarResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
export const QueryAllStarRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllStarRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllStarResponse = {};
export const QueryAllStarResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllStarResponse };
        message.Star = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export class QueryClientImpl {
    ...
    Star(request) {
        ...
        return promise.then((data) => QueryGetStarResponse.decode(new Reader(data)));
    }
    StarAll(request) {
        const data = QueryAllStarRequest.encode(request).finish();
        const promise = this.rpc.request("lubtd.orbit.orbit.Query", "StarAll", data);
        return promise.then((data) => QueryAllStarResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
